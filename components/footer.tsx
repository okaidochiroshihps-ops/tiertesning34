...
export function Footer() {
  ...
  return (
    <footer className="border-t border-border/30 bg-background/60 backdrop-blur-xl mt-auto">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[9px] text-muted-foreground uppercase tracking-widest">{settings.siteTagline}</p>
            </div>
          </div>
            ...
            {settings.discordLink && (
              <a
                ...
                className={cn(
                  ...
                  'text-[#5865F2] text-sm font-medium',
                  'transition-all hover:bg-[#5865F2]/20'
                )}
              >
            ...
            {settings.twitterLink && (
              <a
                ...
                className={cn(
                  ...
                  'transition-all hover:bg-foreground/20'
                )}
              >
                <svg className="h-4 w-4" viewBox="0 0 24 24" fill="currentColor">
